...
do
echo "Fase $(($i))"
../evolution 200 25 1000 1000 1 10 $((4424+$i*127)) 6534 2461 $(($i*19059 % 4000 +1)) 5 5 10 10 10 10 | sed --expression='$!d' >testsNew/Seed1Test$i; diff  testBaseNew/Seed1Test$i testsNew/Seed1Test$i
...
../evolution 200 10 100 1000 2 4 $((44+$i*37)) 55534 $((9361+$i*56)) 100 1 1 50 1 3 1 | sed --expression='$!d' >testsNew/Seed13Test$i; diff  testBaseNew/Seed1Test$i testsNew/Seed1Test$i
...
../evolution 1000 1000 100 100000 0 0 444324 5776534 9542462 2000  500 500 40 40 10 3 | sed --expression='$!d' >testBaseNew/SpotFoodTest;  diff -q testBaseNew/SpotFoodTest testsNew/SpotFoodTest
